...
class BaseModel(ABC):
    ...
    def update_learning_rate(self):
        """Update learning rate for all networks; this function is called at the end of every epoch"""
    ...
    def save_networks(self, epoch):
        ...
        Parameters:
            epoch(int) -- the current epoch; used in the file name '%s_net_%s.pth' % (epoch, name)
        """

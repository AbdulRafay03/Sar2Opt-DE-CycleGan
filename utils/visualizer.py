...
class Visualizer():
    ...
    def __init__(self, opt):
        ...
        if self.display_id > 0:
            ...
            if not self.vis.check_connection():
                # raise VisdomException('Visdom not connected. Plase run "python -m visdom.server" to start the server.')
    ...
    def reset(self):
        """Reset the visualizer: make sure to create a new HTML file"""    
        self.saved = False
